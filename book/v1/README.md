...
[GIN-debug] GET    /api/books/:id            --> main.(*BookApiHandler).GetBook-fm (3 handlers)
[GIN-debug] PUT    /api/books/:id            --> main.(*BookApiHandler).UpdateBook-fm (3 handlers)
[GIN-debug] DELETE /api/books/:id            --> main.(*BookApiHandler).DeleteBook-fm (3 handlers)
